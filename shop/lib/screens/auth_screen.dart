...
class _AuthCardState extends State<AuthCard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slideAnimation = Tween<Offset>(begin: Offset(0, -1.5), end: Offset(0, 0)).animate(CurvedAnimation(parent: _controller, curve: Curves.linear));
  ...
  void _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAILS_EXISTS')) {
